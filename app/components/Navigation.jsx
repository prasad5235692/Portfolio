  ...
  return (
    <>
      ...
      >
        ...
        <div className="desktop-v-list">
          {navItems.map((item) => (
            <div key={item.id} className="desktop-v-item">
        ...
        {menuOpen && (
          ...
          >
            ...
            <motion.div
              ...
              aria-hidden="true"
              initial={reduceMotion ? { opacity: 0 } : { scale: 0.82, opacity: 0 }}
            ...
            <motion.div
              ...
              initial={reduceMotion ? { opacity: 0 } : { scale: 0.92, y: 28, opacity: 0 }}
              animate={{ scale: 1, y: 0, opacity: 1 }}
              exit={reduceMotion ? { opacity: 0 } : { scale: 0.94, y: 16, opacity: 0 }}
              ...
              <nav aria-label="Mobile" className="mnav-list">
                {navItems.map((item, i) => (
                  <motion.button
                    ...
                    transition={{ delay: reduceMotion ? 0 : 0.08 + i * 0.06, duration: reduceMotion ? 0.15 : 0.4, ease: [0.22, 1, 0.36, 1] }}
                  >
